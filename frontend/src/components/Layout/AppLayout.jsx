    ...
    <div className="flex h-screen overflow-hidden" style={{ background: 'var(--bg-void)' }}>
      ...
      <aside className="w-56 flex-shrink-0 flex flex-col"
        ...
        <div className="px-3 py-3 border-b" style={{ borderColor: 'var(--border-dim)' }}>
          <div className="text-[9px] font-bold uppercase tracking-wider mb-1" style={{ color: 'var(--text-muted)' }}>Hazard Score</div>
          <div className="flex items-end gap-2">
            ...
            <span className={`badge badge-${riskLevel} ml-auto text-[8px]`}>{riskLevel}</span>
          </div>
          ...
          {flameDetected && (
            <motion.div animate={{ opacity: [1, 0.3, 1] }} transition={{ repeat: Infinity, duration: 0.6 }}
              className="flex items-center gap-1 mt-2 text-[10px]" style={{ color: '#EF4444' }}>
              <Flame size={10} />
        ...
        <div className="p-3 border-t space-y-2" style={{ borderColor: 'var(--border-dim)' }}>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[9px]" style={{ color: connected ? 'var(--safe)' : 'var(--danger)' }}>
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="text-[10px] font-semibold" style={{ color: 'var(--text-secondary)' }}>{user?.name}</div>
              <div className="text-[9px]" style={{ color: 'var(--text-muted)' }}>{user?.role}</div>
            </div>
